...
AnnotationRecord = namedtuple("AnnotationRecord", ["chrom", "start", "end", "title", "strand"])
...
def unpack_annotation_records(annotation_filename):
    """
    Read a annotation annotation file (bed, gtf, or gff3) into a
    ...
    file_extension = os.path.splitext(os.path.basename(annotation_filename))[1].lower()
